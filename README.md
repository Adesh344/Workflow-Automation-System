...
2. Creates tasks or workflows  
3. On task events → workflow engine triggers  
4. Matching workflows execute actions  
5. Results are stored in Logs  
6. User views execution history  
